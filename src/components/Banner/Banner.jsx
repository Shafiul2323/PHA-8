        ...
        <div className='flex flex-col bg-[#E9E9E9]'>
            <div className='flex flex-col items-center py-10'>
                <div className='space-y-5 text-center'>
                    ...
                    <p className='italic max-w-8/12 mx-auto text-xl pb-5'>At <span className="font-bold">HERO.IO</span> , we craft innovative apps designed to make everyday life simpler, smarter, and more exciting. Our goal is to turn your ideas into digital experiences that truly make an impact</p>
                </div>
